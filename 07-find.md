...
Wenn wir die Option `-r` (rekursiv) verwenden, kann `grep` rekursiv in einer Menge von
...
Sie möchte ein Shell-Skript schreiben, das eine Spezies als erstes Befehlszeilenargument
