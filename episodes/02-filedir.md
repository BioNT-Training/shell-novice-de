...
Innerhalb dieses Verzeichnisses gibt es mehrere andere Verzeichnisse: `bin` (in dem
...
2. Wir können sein Handbuch mit `man` lesen (verfügbar unter Linux und macOS):
